...
const handle_delete_withdrawal = async (btn, withdrawal_request) => {
  ...
  try {
    const response = await fetch(
      "https://momentumgloballtd-server.glitch.me/api/admin/withdrawal/fetch/withdrawal/delete",
      {
        method: "DELETE",
...
(async () => {
  ...
  try {
    const response = await fetch(
      "https://momentumgloballtd-server.glitch.me/api/admin/withdrawal/fetch",
      {
        method: "POST",
        headers: { "content-type": "application/json" },
